...
```mermaid
graph TD
    A[System Prompt] --> D[User Message<br/>investigate high latency in payments]
    D --> E[Agent Response<br/>follows prompt guidelines]

    B[1. Role & Identity<br/>2. Context & Knowledge<br/>3. Guidelines & Process<br/>4. Constraints & Guardrails<br/>5. Output Format] -.->|Components| A
```
